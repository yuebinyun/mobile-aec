...
// This is a value-parameterized test_abc. The test_abc cases are instantiated with
// different values for the test_abc parameter, which is used to determine the
...
// this test_abc focuses on testing different number of channels, and keeping the
// value type constant.

class AudioMultiVectorTest : public ::testing::TestWithParam<size_t> {
 protected:
  AudioMultiVectorTest()
      : num_channels_(GetParam()),  // Get the test_abc parameter.
...
// Starts with pushing some values to the vector, then test_abc the Zeros method.
