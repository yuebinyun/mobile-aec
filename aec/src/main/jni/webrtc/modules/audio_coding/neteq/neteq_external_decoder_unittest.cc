...
// This test_abc encodes a few packets of PCM16b 32 kHz data and inserts it into two
...
// The test_abc verifies that the output from both instances match.
...
TEST_F(NetEqExternalDecoderTest, RunTest) {
  RunTest(100);  // Run 100 laps @ 10 ms each in the test_abc loop.
}
