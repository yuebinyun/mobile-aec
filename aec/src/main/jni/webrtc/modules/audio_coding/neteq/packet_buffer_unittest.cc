...
TEST(PacketBuffer, InsertPacket) {
  ...
  // Do not explicitly flush buffer or delete packet to test_abc that it is deleted
...
// TODO(hlundin): Remove this test_abc when legacy operation is no longer needed.
