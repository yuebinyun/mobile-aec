...
int main(int argc, char* argv[])
{
	...
	if((argc<3) || (argc>17))  {
        ...
        printf("[-F num]        :   if -F option is specified, the test_abc function\n");
        ...
        printf("[-T rate file]  :   test_abc trans-coding with target bottleneck 'rate' bits/sec\n");
	...
	for (i = 1; i < argc-2;i++)
    {
        ...
        //     Do not test_abc it in the first release
        //
        //     if(!strcmp ("-CE", argv[i]))
        //     {
        ...
        //         else if(testCE == 2)
        //         {
        //             printf("\nCE-test_abc 2 (transcoding) not implemented.\n");
        //             exit(0);
        //         }
        //         else if(testCE < 1 || testCE > 3)
        //         {
        //             printf("\n%d is not a valid CE-test_abc number. Valid CE tests are 1-3.\n", testCE);
        //             exit(0);
        //         }
        //         printf("CE-test_abc number: %d\n", testCE);
        //         i++;
        //     }
    }
	...
	*speechType = 1;
    ...
    while (endfile == 0)
    {
        /* Call init functions at random, fault test_abc number 7 */
        ...
        {
            /* Error test_abc number 10, garbage data */
            if(testNum == 10)
            {
            ...
            /* Call getFramelen, only used here for function test_abc */
