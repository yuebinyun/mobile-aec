...
TEST_F(VadTest, ApiTest) {
  // This API test_abc runs through the APIs for all possible valid and invalid
  // combinations.
...
TEST_F(VadTest, ValidRatesFrameLengths) {
  // This test_abc verifies valid and invalid rate/frame_length combinations. We
...
// TODO(bjornv): Add a process test_abc, run on file.
